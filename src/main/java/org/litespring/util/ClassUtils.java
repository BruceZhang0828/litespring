...
public class ClassUtils {
    ...
    public static <T> boolean isAssignableValue(Class<T> type, Object value) {
        Assert.notNull("Type must not be null",type);
        return (value != null ? isAssignable(type, value.getClass()) : !type.isPrimitive());

    }

    public static <T> boolean isAssignable(Class<T> lhsType, Class<?> rhsType) {
        Assert.notNull("Left-hand side type must not be null",lhsType);
        Assert.notNull("Right-hand side type must not be null",rhsType);
